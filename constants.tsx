...
export const AI_ENGINES: AiEngine[] = [
    ...
    },
    {
        ...
        simulationPrompt: 'You are ChatGPT. Respond to the following prompt in a helpful, detailed, and slightly formal tone. Structure your response clearly, often using lists or bullet points to organize information.'
    },
    {
        id: 'grok',
        name: 'Grok',
